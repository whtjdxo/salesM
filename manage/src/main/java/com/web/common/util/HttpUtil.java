...
public class HttpUtil {
	 ...
	 * @return
	 */
	public static Object callURLEuckr(String sURL, HashMap<String, String> getData, HashMap<String, String> postData, String charSet){
        HashMap<String, String> hashmapResult = new HashMap<String, String>();
        ...
        try {
			...
			StringBuilder sb = new StringBuilder();
			Reader in = new BufferedReader(new InputStreamReader(urlConnection.getInputStream(), "EUC-KR"));
			for (int c = 0; (c = in.read()) >=0; ) {
				sb.append((char)c);
			}
			String responseBody = sb.toString();
	 ...
	 * @return
	 */
	public static Object callURLJson(String sURL, String sendData){
        HashMap<String, String> hashmapResult = new HashMap<String, String>();
