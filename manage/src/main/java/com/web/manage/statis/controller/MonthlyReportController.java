...
import com.web.manage.statis.service.MonthlyReportService;
...
public class MonthlyReportController {
    ...
    @RequestMapping("monthReport/view")
    public String view() {
        return "pages/statis/monthlyReport";
    }

    @RequestMapping(value = "monthReport/monthlySummary", method = RequestMethod.POST)
    public @ResponseBody String getMonthlySummary(@RequestBody HashMap<String, Object> hashmapParam, HttpSession session) {
        ...
        try {
            ...
            // System.out.println("getMonthlySummary ===================================");
            list = monthlyReportService.getMonthlySummary(hashmapParam);
            int records = monthlyReportService.getQueryTotalCnt();
            // System.out.println("getMonthlySummaryTotal ===================================");
            totalSumm = monthlyReportService.getMonthlySummaryTotal(hashmapParam);
    ...
    @RequestMapping(value = "monthReport/monthlyList", method = RequestMethod.POST)
    public @ResponseBody String getMonthlyListSummary(@RequestBody HashMap<String, Object> hashmapParam, HttpSession session) {
        HashMap<String, Object> hashmapResult = new HashMap<String, Object>();
        List<HashMap<String, Object>> list = new ArrayList<HashMap<String, Object>>();
        HashMap<String, Object> totalSumm = new HashMap<String, Object>();
        Gson gson = new Gson();
        ...
        try {
            ...
            hashmapParam.put("start", pageing.getStart());
            hashmapParam.put("end", pageing.getLength());
            System.out.println("getMonthlyList ===================================");
            list = monthlyReportService.getMonthlyList(hashmapParam);
            int records = monthlyReportService.getQueryTotalCnt();
            System.out.println("getMonthlyListTotal ===================================");
            totalSumm = monthlyReportService.getMonthlyListTotal(hashmapParam);
    ...
    @RequestMapping(value = "monthReport/downExcel", method = RequestMethod.POST)
    public ResponseEntity<byte[]> getMonthlySummaryToExcel(@RequestBody HashMap<String, Object> hashmapParam, HttpSession session) {
        SessionVO member = (SessionVO) session.getAttribute("S_USER");
        try {
            hashmapParam.put("userCorpCd", member.getUserCorpCd());
		    hashmapParam.put("userCorpType", member.getUserCorpType());
            ...
            List<HashMap<String, Object>> list = monthlyReportService.getMonthlySummary(hashmapParam);
            String closeMonth = hashmapParam.get("sch_month") != null ? hashmapParam.get("sch_month").toString() : "";
            ...
            titleCell.setCellValue("영업월보 (" + closeMonth + ")");            
    ...
    @RequestMapping(value = "monthReport/downListExcel", method = RequestMethod.POST)
    public ResponseEntity<byte[]> getMonthlyListToExcel(@RequestBody HashMap<String, Object> hashmapParam, HttpSession session) {
        SessionVO member = (SessionVO) session.getAttribute("S_USER");
        try {
            hashmapParam.put("userCorpCd", member.getUserCorpCd());
		    hashmapParam.put("userCorpType", member.getUserCorpType());
            ...
            List<HashMap<String, Object>> list = monthlyReportService.getMonthlyList(hashmapParam);
            ...
            sheet.addMergedRegion(new org.apache.poi.ss.util.CellRangeAddress(0, 0, 0, 5));
            Cell titleCell = titleRow.createCell(0);
            titleCell.setCellValue("가맹점 영업월보 (" + closeChain + ")");            
            titleCell.setCellStyle(excelStyle.getStyle("title"));
