...
public class VanDocuMngController {
    ...
    //         // list = vanDocuService.getch(hashmapParam);
    ...
    //     try {
    //         if (vanDocuService.getCeoIdDupChk(ceo_id) == 0) {
    ...
    //         String agency_no = vanDocuService.getNewAgencyNo();
    ...
    //         if (vanDocuService.InsertAgency(agencyVO, userVO)) {
    ...
    //         if (vanDocuService.UpdateAgency(agencyVO, userVO)) {
    ...
    //         if (vanDocuService.UpdateAgencyCont(agencyVO)) {
    //             System.out.println("UpdateAgency  success");
    //             result.setResultCode("S000");
    //             result.setResultMsg("Agency Update successful.");     
