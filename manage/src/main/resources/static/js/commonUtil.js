jQuery(function ($) {
  ...
  $.fn.onLoadFunction = function () {
    $(this).each(function () {
      $(this).find("input[istyle='time']").timepicker({
        showMeridian: false,
        defaultTime: false,
      });
      $(this).find("input[istyle='clock']").clockpicker({
        autoclose: true,
      });
      $(this)
      ...
      $(this)
        ...
        .attr("style", "ime-mode:disabled")
        .attr("maxlength", "10")
        .wrap('<div class="input-group" style="width: 40%;float: left;"> ')
        .after("<span class='input-group-addon'><i class='fa fa-calendar'></i></span>");
      ...
      $(this)
        ...
        .wrap('<div class="input-group"> ')
        .before("<span class='input-group-addon'><i class='fa fa-krw'></i></span>");
      ...
      $(this)
        ...
        .wrap('<div class="input-group"> ')
        .before("<span class='input-group-addon'><i class='fa fa-phone'></i></span>");
      $(this).find("input[istyle='email']").wrap('<div class="input-group"> ').before("<span class='input-group-addon'><i class='fa fa-envelope'></i></span>");
    });
  };
