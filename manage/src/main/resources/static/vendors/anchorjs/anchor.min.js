          ...
          for (
            ...
            if (this.hasAnchorJSLink(e[i])) p.push(i);
              ...
              ((l = document.createElement('a')).className = 'anchorjs-link ' + this.options.class),
                ...
                '' === this.options.icon && ((l.style.font = '1em/1 anchorjs-icons'), 'left' === this.options.placement) && (l.style.lineHeight = 'inherit'),
                'left' === this.options.placement
                  ? ((l.style.position = 'absolute'), (l.style.marginLeft = '-1.25em'), (l.style.paddingRight = '.25em'), (l.style.paddingLeft = '.25em'), e[i].insertBefore(l, e[i].firstChild))
                  : ((l.style.marginLeft = '.1875em'), (l.style.paddingRight = '.1875em'), (l.style.paddingLeft = '.1875em'), e[i].appendChild(l));
            }
