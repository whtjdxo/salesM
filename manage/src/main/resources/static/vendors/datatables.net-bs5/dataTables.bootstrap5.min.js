...
!(function (n) {
  ...
  return (
    ...
    d.extend(!0, n.ext.classes, {
      ...
      layout: { row: 'row mt-2 justify-content-between', cell: 'd-md-flex justify-content-between align-items-center', tableCell: 'col-12', start: 'dt-layout-start col-md-auto me-auto', end: 'dt-layout-end col-md-auto ms-auto', full: 'dt-layout-full col-md' },
    }),
    (n.ext.renderer.pagingButton.bootstrap = function (t, e, n, o, r) {
      ...
      return { display: o, clicker: d('<button>', { class: 'page-link', role: 'link', type: 'button' }).html(n).appendTo(o) };
    }),
